...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://ws.sid.org/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.sid.org/", "ConvertResponse");
    ...
    private final static QName _ListComptes_QNAME = new QName("http://ws.sid.org/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://ws.sid.org/", "listComptesResponse");
